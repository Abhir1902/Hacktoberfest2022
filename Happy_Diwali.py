# We will Draw Happy Diwali in Python Turtle. 
# Turtle is a pre-installed Python module that allows users to
#draw drawings and shapes on a virtual canvas.
...
turtle.title("HacktoberFest 2022 Turtle")
